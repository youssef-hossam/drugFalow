...
import 'package:drug_flow/features/auth/domain/entities/reset_password/reset_password_params.dart';
...
class ResetPasswordCubit extends Cubit<ResetPasswordState> {
  ...
  Future<void>resetPass({ResetPasswordParams? params})async{
    try{
      loading = true;
      error = false;
      success = false;
      ...
      failOrUser.fold((fail){
        ...
        emit(ResetPasswordSuccess(resetPasswordResponse: response));
      });
    }catch(e){
      loading = false;
      error = true;
