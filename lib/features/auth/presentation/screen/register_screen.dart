          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 27.1.h),
                Text(
                  "يرجي ادخال البيانات الخاصه بالصيدلية لإنشاء الحساب",
                ...
                UploadItemWidget(
                  ...
                  title: 'صورة الصيدلية',
                  description:
                      'برجاء رفع صورة للصيدلية, على ان لا يزيد حجم الصورة عن ٥ ميجا',
                ),
                SizedBox(height: 27.1.h),
                UploadItemWidget(
                  img: camera,
                  title: 'صورة الرخصة',
                  description:
                      'برجاء رفع صورة الرخصة, على ان لا يزيد حجم الصورة عن ٥ ميجا',
                ),
                SizedBox(height: 27.1.h),
                CustomTextField(
                  controller: pharmacyController,
                  obscure: false,
                  hintTxt: 'اسم الصيدلية',
                  svgIcon: pharmacy,
                ...
                SizedBox(
                  child: IntlPhoneFormField(
                    ...
                    textInputType: TextInputType.number,
                    title: tr("رقم ارضي للصيدلية"),
                  ),
                ),
                SizedBox(height: 16.2.h),
                LocationDropDownFormField(
                  hintText: 'حدد المحافظة',
                  title: 'المحافظة',
                  dropDownId: 1,
                  type: '',
                ),
                SizedBox(height: 23.2.h),
                LocationDropDownFormField(
